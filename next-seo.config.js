export default {
  title: 'juke.fr',
  description: 'personnal portfolio of an open-sourcerer. I develop backend applications in Node.js and Typescript. I ❤ REST APIs.',
  openGraph: {
    type: 'website',
    locale: 'en_FR',
    url: 'https://juke.fr/',
    title: 'juke.fr',
    description: 'personnal blog of an open-sourcerer. I develop backend applications in Node.js and Typescript. I ❤ REST APIs.',
